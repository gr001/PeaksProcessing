...
namespace Microsoft.Research.DynamicDataDisplay.Charts.Maps
{
    public sealed class TileServerSystem : DispatcherObject, ITileSystem
    {
		...
		private bool autoSwitchToOffline = true;
		...
		private int errorsCountToSwitchToOffline = 10;
		public int ErrorsCountToSwitchToOffline
		{
			get { return errorsCountToSwitchToOffline; }
			set { errorsCountToSwitchToOffline = value; }
		}
        ...
        public TileSystemMode Mode
        {
            ...
            set
            {
                if (mode != value)
                {
					if (value != TileSystemMode.CacheOnly)
					{
						errorsCount = 0;
					}
