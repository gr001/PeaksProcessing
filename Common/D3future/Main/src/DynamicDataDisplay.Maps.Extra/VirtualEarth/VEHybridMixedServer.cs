...
{
	public sealed class VEHybridMixedServer : VEHybridServer
	{
		public VEHybridMixedServer()
		{
		...
		private readonly VEHybridResourceServer resourceServer = new VEHybridResourceServer();
