...
namespace Microsoft.Research.DynamicDataDisplay.DirectX11
{
    public class DXLineGraph : DXPlotterElement, IOneDimensionalChart
    {
        ...
        public Color LineColor
        {
            ...
            set
            {
                if (m_lineColor != value)
                {
                    ...
                    if (this.device != null)
                        this.SetShaderLineColor(new ColorRgba(value.ScR, value.ScG, value.ScB, value.ScA));
                }
            }
        }
        Color m_lineColor = Colors.Red;
        ...
        {
            deviceContext.IA.PrimitiveTopology = PrimitiveTopology.LineStrip;
            ...
            SetShaderMatrices();
            SetShaderLineColor(new ColorRgba(m_lineColor.ScR, m_lineColor.ScG, m_lineColor.ScB, m_lineColor.ScA));
