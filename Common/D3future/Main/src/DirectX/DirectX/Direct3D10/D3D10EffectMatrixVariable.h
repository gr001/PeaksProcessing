...
using namespace System;
    ...
    public: 
        ...
        cli::array<Matrix4x4F>^ GetMatrixArray(UInt32 offset, UInt32 count);
        ...
        cli::array<Matrix4x4F>^ GetMatrixTransposeArray(UInt32 offset, UInt32 count);
        ...
        void SetMatrixArray(cli::array<Matrix4x4F>^ data, UInt32 offset);
        ...
        void SetMatrixTransposeArray(cli::array<Matrix4x4F>^ data, UInt32 offset);
