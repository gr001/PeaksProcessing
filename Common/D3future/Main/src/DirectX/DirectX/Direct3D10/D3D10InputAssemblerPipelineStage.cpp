 ...
 ReadOnlyCollection<VertexBuffer>^ InputAssemblerPipelineStage::GetVertexBuffers(UInt32 startSlot, UInt32 bufferCount)
{
    ...
    cli::array<VertexBuffer>^ bufferList = gcnew cli::array<VertexBuffer>(bufferCount);
...
void InputAssemblerPipelineStage::SetVertexBuffers(UInt32 startSlot, IEnumerable<D3DBuffer^>^ vertexBuffers, cli::array<UInt32>^ strides, cli::array<UInt32>^ offsets)
{
...
void InputAssemblerPipelineStage::SetVertexBuffers(UInt32 startSlot, IEnumerable<VertexBuffer>^ vertexBuffers)
{
    ...
    cli::array<UInt32>^ strides = gcnew cli::array<UInt32>(buffers->Count);
    cli::array<UInt32>^ offsets = gcnew cli::array<UInt32>(buffers->Count);
