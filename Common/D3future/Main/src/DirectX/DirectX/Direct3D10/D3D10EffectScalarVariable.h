...
using namespace System;
    ...
    public: 
        ...
        cli::array<Boolean>^ GetBooleanArray(UInt32 count);
        ...
        void SetBooleanArray(cli::array<Boolean>^ data);
        ...
        cli::array<Int32>^ GetInt32Array(UInt32 count);
        ...
        /// </summary>
        /// <param name="data">The array of variables to set.</param>
        void SetInt32Array(cli::array<Int32>^ data);
        ...
        cli::array<Single>^ GetSingleArray(UInt32 count);
        ...
        /// </summary>
        /// <param name="data">The array of variables to set.</param>
        void SetSingleArray(cli::array<Single>^ data);
