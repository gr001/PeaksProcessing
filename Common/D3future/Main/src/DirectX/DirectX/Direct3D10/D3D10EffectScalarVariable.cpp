...
cli::array<Boolean>^ EffectScalarVariable::GetBooleanArray(UInt32 count)
{
    cli::array<Boolean>^ arr = gcnew cli::array<Boolean>(count);
...
cli::array<Single>^ EffectScalarVariable::GetSingleArray(UInt32 count)
{
    cli::array<Single>^ arr = gcnew cli::array<Single>(count);
...
cli::array<int>^ EffectScalarVariable::GetInt32Array(UInt32 count)
{
    cli::array<Int32>^ arr = gcnew cli::array<Int32>(count);
...
void EffectScalarVariable::SetBooleanArray(cli::array<Boolean>^ data)
{
...
void EffectScalarVariable::SetSingleArray(cli::array<Single>^ data)
{
    UINT count = data->Length;
...
void EffectScalarVariable::SetInt32Array(cli::array<Int32>^ data)
{
    UINT count = data->Length;
