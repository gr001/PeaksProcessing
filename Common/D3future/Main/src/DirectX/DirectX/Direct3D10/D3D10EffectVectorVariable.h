...
using namespace System;
    ...
    public: 
        ...
        cli::array<Vector4B>^ GetBoolVectorArray(UInt32 count);
        ...
        cli::array<Vector4F>^ GetFloatVectorArray(UInt32 count);
        ...
        cli::array<Vector4I>^ GetIntVectorArray(UInt32 count);
        ...
        void SetBoolVectorArray(cli::array<Vector4B>^ data);
        ...
        void SetFloatVectorArray(cli::array<Vector4F>^ data);
        ...
        void SetIntVectorArray(cli::array<Vector4I>^ data);
