...
cli::array<Vector4B>^ EffectVectorVariable::GetBoolVectorArray(UInt32 count)
{
    if (count == 0)
        return nullptr;
    ...
    cli::array<Vector4B>^ arr = gcnew cli::array<Vector4B>(count);
...
cli::array<Vector4F>^  EffectVectorVariable::GetFloatVectorArray(UInt32 count)
{
    if (count == 0)
        return nullptr;

    cli::array<Vector4F>^ arr = gcnew cli::array<Vector4F>(count);
...
cli::array<Vector4I>^ EffectVectorVariable::GetIntVectorArray(UInt32 count)
{
    if (count == 0)
        return nullptr;

    cli::array<Vector4I>^ arr = gcnew cli::array<Vector4I>(count);
...
void EffectVectorVariable::SetBoolVectorArray(cli::array<Vector4B>^ data)
{
    if (data == nullptr)
    {
...
void EffectVectorVariable::SetFloatVectorArray(cli::array<Vector4F>^ data)
{
    if (data == nullptr)
    {
        throw gcnew ArgumentNullException("data", "Must be a valid array.");
...
void EffectVectorVariable::SetIntVectorArray(cli::array<Vector4I>^ data)
{
    if (data == nullptr)
    {
        throw gcnew ArgumentNullException("data", "Must be a valid array.");
