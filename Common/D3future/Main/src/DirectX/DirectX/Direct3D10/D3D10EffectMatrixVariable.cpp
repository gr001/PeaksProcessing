...
cli::array<Matrix4x4F>^ EffectMatrixVariable::GetMatrixArray(UInt32 offset, UInt32 count)
{
    cli::array<Matrix4x4F>^ matrix = gcnew cli::array<Matrix4x4F>(count);
...
cli::array<Matrix4x4F>^ EffectMatrixVariable::GetMatrixTransposeArray(UInt32 offset, UInt32 count)
{
    cli::array<Matrix4x4F>^ matrix = gcnew cli::array<Matrix4x4F>(count);
    pin_ptr<FLOAT> pinnedArray = &matrix[0].dangerousFirstField;
...
void EffectMatrixVariable::SetMatrixArray(cli::array<Matrix4x4F>^ data, UInt32 offset)
{
...
void EffectMatrixVariable::SetMatrixTransposeArray(cli::array<Matrix4x4F>^ data, UInt32 offset)
{
    pin_ptr<FLOAT> matrix = &data[0].dangerousFirstField;
