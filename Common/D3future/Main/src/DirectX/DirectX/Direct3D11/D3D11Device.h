...
namespace Microsoft { namespace WindowsAPICodePack { namespace DirectX { namespace Direct3D11 {
    ...
    public: 
        ...
        D3DBuffer^ CreateBuffer(BufferDescription description, ... cli::array<SubresourceData>^ initialData);
        ...
        GeometryShader^ CreateGeometryShaderWithStreamOutput(IntPtr shaderBytecode, UInt32 shaderBytecodeLength, IEnumerable<StreamOutputDeclarationEntry>^ streamOutputDeclarations, cli::array<UInt32>^ bufferStrides, UInt32 rasterizedStream, ClassLinkage^ classLinkage);
        ...
        /// <param name="rasterizedStream">The index number of the stream to be sent to the rasterizer stage (ranges from 0 to D3D11_SO_STREAM_COUNT). Set to D3D11_SO_NO_RASTERIZED_STREAM if no stream is to be rasterized.</param>
        /// <returns>A GeometryShader interface, representing the geometry shader that was created. </returns>
        GeometryShader^ CreateGeometryShaderWithStreamOutput(IntPtr shaderBytecode, UInt32 shaderBytecodeLength, IEnumerable<StreamOutputDeclarationEntry>^ streamOutputDeclarations, cli::array<UInt32>^ bufferStrides, UInt32 rasterizedStream);
        ...
        /// <param name="classLinkage">A class linkage object (see <see cref="ClassLinkage"/>)<seealso cref="ClassLinkage"/>; the value can be null.</param>
        /// <returns>A GeometryShader interface, representing the geometry shader that was created. </returns>
        GeometryShader^ CreateGeometryShaderWithStreamOutput(Stream^ shaderStream, IEnumerable<StreamOutputDeclarationEntry>^ streamOutputDeclarations, cli::array<UInt32>^ bufferStrides, UInt32 rasterizedStream, ClassLinkage^ classLinkage);
        ...
        /// <param name="rasterizedStream">The index number of the stream to be sent to the rasterizer stage (ranges from 0 to D3D11_SO_STREAM_COUNT). Set to D3D11_SO_NO_RASTERIZED_STREAM if no stream is to be rasterized.</param>
        /// <returns>A GeometryShader interface, representing the geometry shader that was created. </returns>
        GeometryShader^ CreateGeometryShaderWithStreamOutput(Stream^ shaderStream, IEnumerable<StreamOutputDeclarationEntry>^ streamOutputDeclarations, cli::array<UInt32>^ bufferStrides, UInt32 rasterizedStream);
        ...
        Texture1D^ CreateTexture1D(Texture1DDescription description, ... cli::array<SubresourceData>^ initialData);
        ...
        Texture2D^ CreateTexture2D(Texture2DDescription description, ... cli::array<SubresourceData>^ initialData);
        ...
        Texture3D^ CreateTexture3D(Texture3DDescription description, ... cli::array<SubresourceData>^ initialData);
    ...
    public:
        ...
        static D3DDevice^ CreateDeviceAndSwapChain(
            ...
            cli::array<FeatureLevel>^ featureLevels,
