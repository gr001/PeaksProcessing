...
void ComputeShaderPipelineStage::SetUnorderedAccessViews(UInt32 startSlot, IEnumerable<UnorderedAccessView^>^ unorderedAccessViews, cli::array<UInt32>^ initialCounts)
{
