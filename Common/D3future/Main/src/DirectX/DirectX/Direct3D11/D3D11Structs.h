...
public:
    ...
    property IEnumerable<RenderTargetBlendDescription>^ RenderTarget
    {
        IEnumerable<RenderTargetBlendDescription>^ get()
        {
            ...
            {
                renderTarget  = gcnew cli::array<RenderTargetBlendDescription>(RenderTargetArrayLength);
            }
...
private:
    ...
    cli::array<RenderTargetBlendDescription>^ renderTarget;
...
public:
    ...
    property Texture2DMultisampleDepthStencilView Texture2DMultisample
    {
        ...
        {
            return m_texture2DMultisample;
        }

        void set(Texture2DMultisampleDepthStencilView value)
        {
			m_texture2DMultisample = value;
        }
    }
    /// <summary>
    ...
    property Texture2DMultisampleArrayDepthStencilView Texture2DMultisampleArray
    {
        ...
        {
            return m_texture2DMultisampleArray;
        }

        void set(Texture2DMultisampleArrayDepthStencilView value)
        {
			m_texture2DMultisampleArray = value;
        }
    }
...
private:
    ...
    [FieldOffset(8)]
    DepthStencilViewOptions m_flags;
    [FieldOffset(12)]
    Texture1DDepthStencilView m_texture1D;
    [FieldOffset(12)]
    Texture1DArrayDepthStencilView m_texture1DArray;
    [FieldOffset(12)]
    Texture2DDepthStencilView m_texture2D;
    [FieldOffset(12)]
    Texture2DArrayDepthStencilView m_texture2DArray;
    [FieldOffset(12)]
    Texture2DMultisampleDepthStencilView m_texture2DMultisample;
    [FieldOffset(12)]
    Texture2DMultisampleArrayDepthStencilView m_texture2DMultisampleArray;
