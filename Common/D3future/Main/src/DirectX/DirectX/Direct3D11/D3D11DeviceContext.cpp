...
void DeviceContext::ClearUnorderedAccessViewFloat(UnorderedAccessView^ unorderedAccessView, cli::array<Single>^ values)
{
    if (values == nullptr)
    {
...
void DeviceContext::ClearUnorderedAccessViewUInt32(UnorderedAccessView^ unorderedAccessView, cli::array<UInt32>^ values)
{
    if (values == nullptr)
    {
        throw gcnew ArgumentNullException("values");
