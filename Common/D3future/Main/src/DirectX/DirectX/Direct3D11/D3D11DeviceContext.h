...
ref class VertexShaderPipelineStage;
    ...
    public: 
        ...
        void ClearUnorderedAccessViewFloat(UnorderedAccessView^ unorderedAccessView, cli::array<Single>^ values);
        ...
        /// <param name="unorderedAccessView">Pointer to the Unordered Access View.</param>
        /// <param name="values">A 4-component array that contains the values.</param>
        void ClearUnorderedAccessViewUInt32(UnorderedAccessView^ unorderedAccessView, cli::array<UInt32>^ values);
