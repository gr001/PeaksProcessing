...
D2DBitmap::CopyFromMemory(
    RectU destinationRect,
    cli::array<unsigned char>^ sourceData,
    UINT32 pitch
    )
{
    D2D1_RECT_U tempRect;
...
void GradientStopCollection::CopyTo(cli::array<GradientStop>^ destinationArray, int arrayIndex)
{
	EnsureGradientStops();
...
D2DBitmap^ RenderTarget::CreateBitmap(
    SizeU size,
    cli::array<unsigned char>^ source,
    UINT32 pitch,
    BitmapProperties bitmapProperties
    )
{
