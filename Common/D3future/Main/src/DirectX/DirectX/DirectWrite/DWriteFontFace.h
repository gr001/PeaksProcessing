...
namespace Microsoft { namespace WindowsAPICodePack { namespace DirectX { namespace DirectWrite {
    ...
    public: 
        ...
        /// </returns>
        cli::array<GlyphMetrics>^ GetDesignGlyphMetrics(
            cli::array<UINT16>^ glyphIndexes,
            BOOL isSideways);
        ...
        /// The metrics returned by this function are in font design units.
        /// </returns>
        cli::array<GlyphMetrics>^ GetDesignGlyphMetrics(cli::array<UINT16>^ glyphIndexes);
        ...
        /// </returns>
        cli::array<UINT16>^ GetGlyphIndexes(cli::array<UINT32>^ codePoints);
        ...
        /// Array of nominal glyph indices filled by this function.
        /// </returns>
        cli::array<UINT16>^ GetGlyphIndexes(cli::array<System::Char>^ characterArray);
        ...
        /// Array of nominal glyph indices filled by this function.
        /// </returns>
        cli::array<UINT16>^ GetGlyphIndexes(System::String^ text);
