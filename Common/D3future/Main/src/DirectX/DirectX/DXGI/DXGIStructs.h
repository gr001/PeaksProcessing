...
public:
    ColorRgba(cli::array<float>^ rgbaColors)
    {
...
public:
    ...
    property IEnumerable<ColorRgb>^ GammaCurve
    {
        IEnumerable<ColorRgb>^ get()
        {
            ...
            {
                gammaCurveArray = gcnew cli::array<ColorRgb>(GammaCurveArrayLength);
            }
...
private:
    cli::array<ColorRgb>^ gammaCurveArray;
...
public:
    ...
    property IEnumerable<Single>^ ControlPointPositions
    {
        IEnumerable<Single>^ get()
        {
            ...
            {
                controlPointsPositions = gcnew cli::array<Single>(ControlPointPositionsArrayLength);
            }
...
private:
    cli::array<Single>^ controlPointsPositions;
